...
function AppNavigation() {
  ...
  function StartStackScreen({ navigation, route }) {
    React.useLayoutEffect(() => {
      ...
      if (routeName === 'GetStart' || routeName === undefined || routeName === 'Login' || routeName === 'Register') {
  ...
  function ViewProfile(){
    return (
      <StartStack.Navigator>
        <StartStack.Screen name="Menu" component={MenuScreen} options={{ headerShown: false }} />
        <StartStack.Screen name="Profile" component={Profile} options={{ headerShown: false }} />
      </StartStack.Navigator>
    )
  }
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Tab.Screen name="Other" component={/*MenuScreen*/ ViewProfile} />
      </Tab.Navigator>
    </NavigationContainer>
  );
}
